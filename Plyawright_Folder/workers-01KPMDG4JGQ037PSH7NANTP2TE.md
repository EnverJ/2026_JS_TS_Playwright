...
runme:
  document:
    relativePath: workers.md
  session:
    id: 01KPMDG4JGQ037PSH7NANTP2TE
    updated: 2026-04-20 23:49:44-06:00
---
...
- Tests pass locally but fail on CI with `Timeout of 30***ms exceeded`
...
# Ran on 2026-04-20 23:49:36-06:00 for 421ms exited with 0
# Tuning Playwright Workers: Why 50% CPU Usage Is the Sweet Spot
